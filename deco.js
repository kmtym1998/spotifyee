...
// var colors = new Array(
//     [62,35,255], //3e23ff blue
//     [60,255,60], //3cff3c green
//     [255,35,98], //ff2362 red
//     [45,175,230], //2dafe6 blue
...
$(function(){
    ...
    $('.tab-buttons span').on('click', function(){
        ...
        $('#body').css('height', $('#results-wrapper').height() + 1000 + 'px');
    });
    //TAB END ----------------------------------------------
